...
numLines =  100000# This is the number of entries into the dictionary

singleSpaceDictionary = False # This is for wellformed dictionarys. The spec is that there is only one space. You can set it to false if you want it to generate more spaces.

testlen = 100000 # Number of words to use in it
